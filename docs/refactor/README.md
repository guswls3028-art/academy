...
| [failure-transparency-stabilization.md](failure-transparency-stabilization.md) | repo-confirmed / runtime-unverified | 가드·조용한 실패·중복 저장·강제 reload의 정상 이용 복구 후보와 검증 경계 |
